...
if (isset($_POST['sourceid'])) {
    ...
    $sql = "SELECT distinct tt_partner FROM teletrax_hits WHERE source_id = $ttx_id and (tt_detection_start >= '" . $sdate . " 00:00:00' AND tt_detection_start < '" . $edate . " 23:59:59' )  and selfhit <> 'YES' ORDER BY tt_partner asc ";
    //echo $sql;
    ...
    $sql = "SELECT source_title,source_partner,tt_asset,source_id, source_date FROM teletrax_hits WHERE tt_detection_start >= '".$sdate."' AND tt_detection_start < '".$edate."'   and tt_partner = '".$ttx_id."'  and selfhit <> 'YES'  group by tt_asset order by source_partner asc ";
    //echo $sql;
    $result = $CoID->query($sql) ;
